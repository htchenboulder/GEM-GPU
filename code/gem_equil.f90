...
!for including bstar effects
  ...
  !$acc declare create(jfn,radius,t0s,tgis,dbdr,gr,bdcrvb,qhat,f,grdgt,capts,grcgt,dydr,gxdgy,phincp,sf,capns,bfld,xn0s,vparsp,thfnz,psip,psip2,curvbz,dipdr,dbdth)
!  real,external :: erf
