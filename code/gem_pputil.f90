...
!===========================================================================
  SUBROUTINE init_pmove(xp, np, lz, ierr)
    ...
    !
    !!$acc host_data use_device (s_counts,r_counts)
    ...
    nsize = sum(r_counts)
    !!$acc end kernels
    !!$acc update host(r_counts,r_displ)
