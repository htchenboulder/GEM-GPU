...
program gem_main
  ...
  do  timestep=ncurr,nm
     ...
     PERFSTUBS_START_STRING('push')
     call push_wrapper(timestep,0)
     PERFSTUBS_STOP_STRING('push')
     push_end_tm=push_end_tm+MPI_WTIME()
